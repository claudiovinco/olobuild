<template>
  <div class="mb-space-y-2">
    ...
    <div class="mb-flex mb-items-center mb-gap-2">
      <label class="mb-text-[10px] mb-text-gray-500 mb-w-16">Rotazione</label>
    ...
    <!-- Scale -->
    <div class="mb-flex mb-items-center mb-gap-2">
      <label class="mb-text-[10px] mb-text-gray-500 mb-w-16">Scala</label>
    ...
    <div class="mb-flex mb-gap-2">
      <div class="mb-flex-1 mb-flex mb-items-center mb-gap-1">
        ...
        <input type="number" :value="val.translateX" @input="update('translateX', $event.target.value)"
          min="-500" max="500" aria-label="Spostamento orizzontale (px)"
      ...
      <div class="mb-flex-1 mb-flex mb-items-center mb-gap-1">
        ...
        <input type="number" :value="val.translateY" @input="update('translateY', $event.target.value)"
          min="-500" max="500" aria-label="Spostamento verticale (px)"
          class="mb-w-full mb-bg-gray-700 mb-border mb-border-gray-600 mb-rounded mb-px-2 mb-py-1 mb-text-xs mb-text-gray-200" />
      </div>
    </div>
    <!-- Skew X/Y -->
    <div class="mb-flex mb-gap-2">
      <div class="mb-flex-1 mb-flex mb-items-center mb-gap-1">
        <label class="mb-text-[10px] mb-text-gray-500 mb-w-10">SkewX</label>
        <input type="number" :value="val.skewX" @input="update('skewX', $event.target.value)" min="-45" max="45"
          class="mb-w-full mb-bg-gray-700 mb-border mb-border-gray-600 mb-rounded mb-px-2 mb-py-1 mb-text-xs mb-text-gray-200" />
      </div>
      <div class="mb-flex-1 mb-flex mb-items-center mb-gap-1">
        <label class="mb-text-[10px] mb-text-gray-500 mb-w-10">SkewY</label>
    ...
    <!-- Origin -->
    <div class="mb-flex mb-items-center mb-gap-2">
      <label class="mb-text-[10px] mb-text-gray-500 mb-w-16">Origine</label>
      <select :value="val.origin" @change="update('origin', $event.target.value)"
        ...
        <option value="center left">Centro SX</option>
        <option value="center right">Centro DX</option>
