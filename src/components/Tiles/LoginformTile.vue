<template>
  <div class="olo-loginform-preview" :style="wrapStyle">
    ...
    <div v-if="showLoggedIn" style="text-align:center;padding:20px 0;">
      ...
      <div style="font-size:14px;opacity:0.6;margin-top:4px;" :style="{ color: s.text_color || 'var(--olo-color-text-muted, #9CA3AF)' }">Mario Rossi</div>
      <a href="#" style="font-size:13px;margin-top:16px;display:inline-block;text-decoration:none;font-weight:500;" :style="{ color: linkColor }">Esci</a>
    </div>
    ...
    <template v-if="!showLoggedIn">
      ...
      <form v-if="showLogin" @submit.prevent>
        ...
        <div style="margin-bottom:16px;">
          <label v-if="true" :style="labelStyle">Nome utente o email</label>
          <div :style="inputWrapStyle">
            <span v-if="s.show_input_icons" :style="inputIconStyle">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
            </span>
            <input type="text" placeholder="nome@esempio.it" :style="inputFieldStyle" disabled />
          </div>
        </div>
        <!-- Password -->
        <div style="margin-bottom:16px;">
          ...
          <div :style="inputWrapStyle">
            ...
            <input :type="showPwLogin ? 'text' : 'password'" placeholder="La tua password" :style="inputFieldStyle" disabled />
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;">
          ...
          <span v-else></span>
          <a v-if="s.show_lost_password" href="#" style="font-size:13px;text-decoration:none;font-weight:500;" :style="{ color: linkColor }">Password dimenticata?</a>
        </div>
        ...
        <div v-if="s.mode === 'both'" style="text-align:center;margin-top:16px;font-size:13px;" :style="{ color: s.text_color || 'var(--olo-color-text-muted, #9CA3AF)' }">
          Non hai un account? <a href="#" @click.prevent="activeTab = 'register'" style="text-decoration:none;font-weight:600;" :style="{ color: linkColor }">Registrati</a>
        </div>
      </form>
          ...
          <template v-for="(rf, ri) in regFields" :key="rf.id || ri">
            ...
            <div v-else-if="rf.field_type === 'user_password'" :style="fieldWidthStyle(rf)" style="margin-bottom:0 !important;">
              ...
              <div v-if="s.show_password_strength" style="margin-top:8px;">
                ...
                <div style="font-size:11px;margin-top:4px;color:#F59E0B;">Media</div>
              </div>
