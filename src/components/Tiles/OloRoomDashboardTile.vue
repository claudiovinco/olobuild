...
const bookings = [
  ...
  { room: 'Auditorium Melotti', date: '28 Feb 2026, 14:00-17:00', status: 'In attesa', bg: '#fef3c7', color: '#92400e' },
  { room: 'Sala Tartarotti', date: '3 Mar 2026, 10:00-12:00', status: 'Approvata', bg: '#dcfce7', color: '#166534' },
];
</script>
