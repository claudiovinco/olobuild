 ...
 *
 * PROBLEMA RISOLTO: il campo `preset` (12 voci) di `megamenu.js` ora applica
 * davvero una ricetta. Ogni preset = un bundle di CHIAVI GIA' ESISTENTI (nessuna
 * chiave nuova, nessun salvataggio rotto). Viene applicato dal dispatcher
 * `applyTilePresetTheme` in BuilderInspector al cambio di `settings.preset`; i
 * valori restano sovrascrivibili dal cliente nell'inspector.
 *
 * REGOLE rispettate:
