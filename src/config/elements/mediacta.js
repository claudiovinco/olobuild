...
export default {
  ...
  styleFields: [
    ...
    { key: 'accent', label: t('Accento (parola + occhiello)'), type: 'color',
      description: t('Vuoto = primario del tema.') },
    { key: 'accent_on', label: t('Testo su accento'), type: 'color' },
    { key: 'btn_bg', label: t('CTA — sfondo (vuoto = accento)'), type: 'color' },
    { key: 'btn_color', label: t('CTA — testo (vuoto = testo su accento)'), type: 'color' },
    ...
    { key: 'overlay_type', label: t('Tipo velo'), type: 'select', options: [
      { value: 'linear', label: t('Lineare (alto → basso)') },
      { value: 'radial', label: t('Radiale (dal basso-centro)') },
    ]},
    { key: 'overlay_color', label: t('Colore velo'), type: 'color' },
    { key: 'overlay_top', label: t('Velo alto/esterno (opacità)'), type: 'range', min: 0, max: 1, step: 0.02 },
    { key: 'overlay_bottom', label: t('Velo basso/interno (opacità)'), type: 'range', min: 0, max: 1, step: 0.02 },
