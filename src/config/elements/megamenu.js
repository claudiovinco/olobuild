...
export default {
  ...
  styleFields: [
    ...
    { type: 'typography', label: t('Testo logo'), responsiveKeys: [], keys: { size: 'logo_text_size', color: 'logo_text_color' }, sizeMin: 12, sizeMax: 40, condition: { field: 'logo_text', op: 'ne', value: '' } },
