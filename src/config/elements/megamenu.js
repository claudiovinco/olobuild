...
export default {
  ...
  defaults: {
    ...
    btn_hover_bg: '',
    // Padding interno unificato (4 lati). I legacy btn_padding_v/h restano letti
    // dal PHP come fallback per i template salvati prima di questa chiave.
  ...
  fields: [
    ...
    { key: 'logo_text', label: t('Logo testuale (wordmark, se senza immagine)'), type: 'text' },
    { key: 'logo_dot', label: t('Pallino prima del testo'), type: 'toggle', condition: { field: 'logo_text', op: 'ne', value: '' } },
    { key: 'logo_dot_position', label: t('Pallino — posizione'), type: 'select', options: [
      { value: 'before', label: t('Prima del testo') },
      { value: 'inline', label: t('Sul punto (clod.eu)') },
    ], condition: { field: 'logo_dot', value: true },
    ...
    { type: 'separator', label: t('Telefono in header') },
    { key: 'nav_phone', label: t('Telefono in header (testo)'), type: 'text' },
    { key: 'nav_phone_url', label: t('Telefono — link (tel:)'), type: 'link', condition: { field: 'nav_phone', op: 'ne', value: '' } },
    { key: 'nav_phone_color', label: t('Telefono — colore'), type: 'color', condition: { field: 'nav_phone', op: 'ne', value: '' } },
    ...
    { key: 'social_instagram', label: t('Instagram URL'), type: 'link' },
    { key: 'social_x', label: t('X (Twitter) URL'), type: 'link' },
    { key: 'social_linkedin', label: t('LinkedIn URL'), type: 'link' },
    { key: 'social_youtube', label: t('YouTube URL'), type: 'link' },
    { key: 'social_tiktok', label: t('TikTok URL'), type: 'link' },
    { key: 'social_pinterest', label: t('Pinterest URL'), type: 'link' },
    { key: 'social_whatsapp', label: t('WhatsApp URL'), type: 'link' },
    ...
    { key: 'extra_link_1_button', label: t('Voce 1 — Stile pulsante (CTA)'), type: 'toggle' },
    { key: 'extra_link_1_cart', label: t('Voce 1 — Carrello WooCommerce'), type: 'toggle',
      description: t('URL automatico alla pagina carrello + conteggio articoli "(n)" aggiornato live.') },
    ...
    { key: 'extra_link_2_button', label: t('Voce 2 — Stile pulsante (CTA)'), type: 'toggle' },
    { key: 'extra_link_2_cart', label: t('Voce 2 — Carrello WooCommerce'), type: 'toggle' },
    ...
    { key: 'extra_link_3_cart', label: t('Voce 3 — Carrello WooCommerce'), type: 'toggle' },
    ...
    { key: 'extra_link_4_cart', label: t('Voce 4 — Carrello WooCommerce'), type: 'toggle' },
    { key: 'extra_links_right', label: t('Link extra in gruppo a destra'), type: 'toggle',
      description: t('Rende i link extra come gruppo separato allineato a destra (es. Search/Account/Bag con logo centrato).') },
    ...
    { key: 'timecode_color', label: t('Colore timecode'), type: 'color',
      condition: { field: 'show_timecode', value: true } },
  ...
  styleFields: [
    ...
    { key: 'btn_border_color', label: t('Colore bordo pulsante'), type: 'color',
      show: showBtnAspect },
    { key: 'btn_font_size', label: t('Dimensione testo (px, 0 = come voci nav)'), type: 'range', min: 0, max: 24, step: 1,
      show: showBtnAspect },
    { key: 'btn_font_weight', label: t('Peso testo'), type: 'select', options: [
      { value: '400', label: t('Normale') },
      { value: '500', label: t('Medio') },
      { value: '600', label: t('Semi-bold') },
      { value: '700', label: t('Bold') },
    ], show: showBtnAspect },
    { key: 'btn_transform', label: t('Maiuscole/minuscole'), type: 'select', options: [
      { value: 'none', label: t('Come scritto') },
      { value: 'uppercase', label: t('MAIUSCOLO') },
      { value: 'capitalize', label: t('Iniziali Maiuscole') },
    ], show: showBtnAspect },
    { key: 'btn_letter_spacing', label: t('Spaziatura lettere (px)'), type: 'range', min: 0, max: 4, step: 0.5,
      show: showBtnAspect },
    { key: 'btn_hover_color', label: t('Colore testo (hover)'), type: 'color',
      show: showBtnAspect },
    ...
    { key: 'btn_hover_effect', label: t('Effetto hover'), type: 'select', options: [
      { value: 'lift', label: t('Solleva (default)') },
      { value: 'scale', label: t('Ingrandisci') },
      { value: 'glow', label: t('Alone (ombra morbida)') },
      { value: 'none', label: t('Nessuno') },
    ], show: showBtnAspect },
