...
export default {
  ...
  fields: [
    ...
    { key: 'nav_phone_url', label: t('Telefono — link (tel:)'), type: 'text', condition: { field: 'nav_phone', op: 'ne', value: '' } },
    ...
    { key: 'mobile_link_font', label: t('Fullscreen — font voci'), type: 'select',
      condition: { field: 'mobile_style', value: 'fullscreen' }, options: [
        { value: 'inherit', label: t('Predefinito (sans)') },
