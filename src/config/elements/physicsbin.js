...
export default {
  ...
  defaults: {
    ...
    bg: { type: 'none' },
    items: [
      { id: 'pb-1', shape: 'circle', color: 'var(--olo-color-primary, #e1474f)', radius: '46', glyph: '★', image: '' },
      ...
      { id: 'pb-6', shape: 'circle', color: 'var(--olo-color-primary, #e1474f)', radius: '32', glyph: '',  image: '' },
