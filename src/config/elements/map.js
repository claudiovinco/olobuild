...
export default {
  ...
  defaults: {
    ...
    btn_color: 'var(--olo-color-light, #f8f9fa)',
    // Shared
    height: '400',
    shadow: 'none',
  ...
  styleFields: [
    ...
    { key: 'grid_columns', label: t('Colonne griglia'), type: 'range', min: 1, max: 4, step: 1, condition: [{ field: 'mode', value: 'locations' }, { field: 'view_mode', value: 'grid' }] },
    { key: 'grid_columns', label: t('Colonne griglia'), type: 'range', min: 1, max: 4, step: 1, condition: [{ field: 'mode', value: 'services' }, { field: 'view_mode', value: 'grid' }] },
  ],
};
