...
export default {
  ...
  styleFields: [
    ...
    { key: 'h_size_min', label: t('Dimensione min'), type: 'range', min: 20, max: 80, step: 1 },
    { key: 'h_size_vw', label: t('Dimensione fluida'), type: 'range', min: 4, max: 14, step: 0.5 },
    { key: 'h_size_max', label: t('Dimensione max'), type: 'range', min: 60, max: 160, step: 2 },
    ...
    { key: 'glow_y', label: t('Posizione Y glow'), type: 'range', min: -300, max: 200, step: 10 },
