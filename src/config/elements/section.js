...
export default {
  ...
  styleFields: [
    ...
    { key: 'padding_custom', label: t('Padding personalizzato'), type: 'spacing', min: 0, max: 600,
    ...
    { key: 'sticky_top', label: t('Offset dall\'alto'), type: 'number', min: 0, placeholder: '0', condition: { field: 'sticky_effect', operator: '!=', value: 'none' } },
