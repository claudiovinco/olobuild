...
export default {
  ...
  fields: [
    ...
    { key: 'heading_line_height', label: 'Altezza riga titolo', type: 'range', responsive: true, min: 0.8, max: 3, step: 0.05 },
    { key: 'heading_align', label: 'Allineamento titolo', type: 'select', responsive: true, options: [
      { value: '', label: 'Predefinito' },
      { value: 'left', label: 'Sinistra' },
      { value: 'center', label: 'Centro' },
      { value: 'right', label: 'Destra' },
      { value: 'justify', label: 'Giustifica' },
    ]},
