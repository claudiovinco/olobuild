...
export default {
  ...
  styleFields: [
    ...
    { type: 'typography', label: t('Testo sovrapposto'), responsiveKeys: [], keys: { size: 'overlay_text_size', weight: 'overlay_text_weight', color: 'overlay_text_color' }, sizeMin: 12, sizeMax: 120, condition: { field: 'overlay_text', op: 'notEmpty' } },
