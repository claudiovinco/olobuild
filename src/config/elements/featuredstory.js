...
export default {
  ...
  defaults: {
    ...
    kicker_color: 'var(--olo-color-primary, #e1474f)',
    headline_color: 'var(--olo-color-dark, #16263d)',
    accent_color: '',
    standfirst_color: 'var(--olo-color-text, #1f2937)',
    byline_color: 'var(--olo-color-text-soft, #6b7280)',
    byline_name_color: 'var(--olo-color-dark, #16263d)',
    media_bg: 'var(--olo-color-surface-alt, #f6f7f9)',
    cta_solid_bg: 'var(--olo-color-dark, #16263d)',
    cta_solid_text: 'var(--olo-color-light, #f8f9fa)',
    // Fonts
