...
export default {
  ...
  defaults: {
    ...
    // Headline
    headline_lines: [
      { text: 'Costruisci.', color: 'var(--olo-color-dark, #16263d)', italic: false },
      { text: 'Traduci.',    color: 'var(--olo-color-primary, #e1474f)', italic: true  },
      { text: 'Prenota.',    color: 'var(--olo-color-dark, #16263d)', italic: false },
    ],
    ...
    cta1_url:         '#',
    cta1_target:      '_self',
    cta1_bg:          'var(--olo-color-dark, #16263d)',
    cta1_bg_hover:    '',
    cta1_color:       'var(--olo-color-light, #f8f9fa)',
    cta1_color_hover: '',
    cta1_size:        14,
    ...
    // Stats
    stats: [
      { value: '5',      value_color: 'var(--olo-color-dark, #16263d)', label: 'PRODOTTI MODULARI' },
      { value: 'Gratis', value_color: 'var(--olo-color-primary, #e1474f)', label: 'OLOBUILD, PER SEMPRE' },
      { value: '0 %',    value_color: 'var(--olo-color-dark, #16263d)', label: 'SAAS · LOCK-IN · COMMISSIONI' },
    ],
    ...
    showcase_items: [
      { number: '01', text: 'crea',     italic: true, text_color: 'var(--olo-color-dark, #16263d)', bg: { type: 'solid', color: 'var(--olo-color-light, #f8f9fa)' } },
      { number: '02', text: 'anima',    italic: true, text_color: 'var(--olo-color-dark, #16263d)', bg: { type: 'solid', color: 'var(--olo-color-light, #f8f9fa)' } },
      { number: '03', text: 'traduci',  italic: true, text_color: 'var(--olo-color-dark, #16263d)', bg: { type: 'solid', color: 'var(--olo-color-light, #f8f9fa)' } },
      { number: '04', text: 'pubblica', italic: true, text_color: 'var(--olo-color-dark, #16263d)', bg: { type: 'solid', color: 'var(--olo-color-light, #f8f9fa)' } },
    ],
  ...
  fields: [
    ...
    { key: 'panel', label: t('Contenuto del pannello'), type: 'select', options: [
      { value: 'showcase', label: t('Showcase card (griglia 2×2)') },
      { value: 'media',    label: t('Media + badge d\'angolo') },
      { value: 'audio',    label: t('Cover + player audio') },
    ], description: t('Cosa mostra la colonna destra: i campi qui sotto cambiano col pannello scelto.') },
    { key: 'panel_media', label: t('Media del pannello (immagine, video…)'), type: 'background', showParallax: false,
    ...
    { key: 'panel_badge_label', label: t('Badge — etichetta'), type: 'text',
      condition: { field: 'panel', op: 'eq', value: 'media' } },
    { key: 'panel_track_title', label: t('Player — titolo traccia'), type: 'text',
      condition: { field: 'panel', op: 'eq', value: 'audio' } },
    { key: 'panel_track_meta', label: t('Player — artista/album'), type: 'text',
      condition: { field: 'panel', op: 'eq', value: 'audio' } },

    { type: 'separator', label: t('Showcase (lato destro)'), condition: { field: 'panel', op: 'eq', value: 'showcase' } },
