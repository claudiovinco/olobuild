...
export default {
  ...
  styleFields: [
    ...
    { key: 'max_width', label: t('Larghezza max'), type: 'range', min: 600, max: 1600, step: 20 },
    { key: 'min_height', label: t('Altezza minima'), type: 'range', min: 0, max: 100, step: 1 },
    ...
    { key: 'type_size_min', label: t('Dimensione min'), type: 'range', min: 14, max: 40, step: 1 },
    { key: 'type_size_vw', label: t('Dimensione fluida'), type: 'range', min: 1, max: 6, step: 0.2 },
    { key: 'type_size_max', label: t('Dimensione max'), type: 'range', min: 20, max: 64, step: 1 },
    { key: 'type_speed', label: t('Velocità battitura (ms/carattere)'), type: 'range', min: 20, max: 160, step: 5 },
    { key: 'type_pause', label: t('Pausa a fine frase'), type: 'range', min: 400, max: 5000, step: 100 },
    ...
    { key: 'side_width', label: t('Larghezza immagini laterali'), type: 'range', min: 200, max: 800, step: 10 },
