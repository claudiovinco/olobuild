...
export default {
  ...
  fields: [
    ...
    { key: 'hover_border_radius', label: 'Border Radius hover', type: 'border-radius',
      description: 'Vuoto = invariato sul hover' },
    { key: 'hover_radius_duration', label: 'Durata transizione (ms)', type: 'range', min: 100, max: 2000, step: 50,
      condition: { field: 'hover_border_radius', op: 'notEmpty' } },
