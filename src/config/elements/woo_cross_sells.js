...
/**
 * Tile WC Cross-Sell — split CONTENUTO/STILE (regola universale Olobuild).
 *   fields[]      → titolo intestazione, tag heading, limit query, colonne responsive, toggle visibilita
 *   styleFields[] → preset, sfondo, tipografia, text effects, layout grafico, ratio immagine, card style, hover, colori, ombra, bordo
 *   AVANZATE      → meta tecnico (id/class/condizioni)
 */
export default {
  type: 'woo_cross_sells',
  name: t('WC Cross-Sell'),
  icon: 'dashicons-randomize',
  category: 'woocommerce',
  placeholder: t('Prodotti cross-sell WooCommerce'),
  defaults: {
    preset: 'custom',
    bg: { type: 'none' },
    typography_preset: '',
  ...
  fields: [
    ...
    { key: 'show_badge', label: t('Mostra badge'), type: 'toggle' },
  ],
