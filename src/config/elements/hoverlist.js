...
export default {
  ...
  styleFields: [
    ...
    { type: 'description', description: t('Il toggle Normale | Hover di ogni controllo imposta la resa al passaggio del mouse (vuoto = invariata). Rientro vuoto = automatico: 8 px con pastiglia, 4 px nel layout numerato. Una voce con sfondo proprio lo mantiene anche in hover.') },
  ],
};
