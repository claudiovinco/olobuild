...
export default {
  ...
  styleFields: [
    ...
    { key: 'v_icon_size', label: t('Dim. icona'), type: 'range', min: 14, max: 32, step: 2,
      show: s => s.style === 'vertical' && s.v_show_icons },
    ...
    { key: 'hamburger_offset_x', label: t('Offset orizzontale'), type: 'range',
      min: 0, max: 60, step: 2,
      show: s => s.hamburger_position && s.hamburger_position !== 'inline' },
    { key: 'hamburger_offset_y', label: t('Offset verticale'), type: 'range',
      min: 0, max: 60, step: 2,
      show: s => s.hamburger_position && s.hamburger_position !== 'inline' },
    { key: 'hamburger_size', label: t('Dimensione icona'), type: 'range', min: 16, max: 48, step: 2 },
