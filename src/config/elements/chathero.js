...
export default {
  ...
  styleFields: [
    ...
    { key: 'h_size_min', label: t('Dimensione min'), type: 'range', min: 20, max: 70, step: 1 },
    { key: 'h_size_vw', label: t('Dimensione fluida'), type: 'range', min: 3, max: 12, step: 0.1 },
    { key: 'h_size_max', label: t('Dimensione max'), type: 'range', min: 50, max: 140, step: 2 },
    { key: 'max_width', label: t('Larghezza max testo'), type: 'range', min: 480, max: 1200, step: 20 },
    ...
    { key: 'glow_h', label: t('Altezza glow'), type: 'range', min: 200, max: 1000, step: 20 },
    { key: 'glow_blur', label: t('Sfocatura glow'), type: 'range', min: 0, max: 200, step: 5 },
    { key: 'glow_x', label: t('Posizione X glow'), type: 'range', min: 0, max: 100, step: 1 },
    { key: 'glow_y', label: t('Posizione Y glow'), type: 'range', min: -400, max: 200, step: 10 },

    { type: 'separator', label: t('Finestra chat') },
    { key: 'chat_max_width', label: t('Larghezza max finestra'), type: 'range', min: 360, max: 1000, step: 20 },
