...
export default {
  ...
  styleFields: [
    ...
    withHover({ key: 'input_border_radius', label: t('Raggio input'), type: 'border-radius' }),
    ...
    withHover({ key: 'results_border_radius', label: t('Raggio popup'), type: 'border-radius' }),
    ...
    { key: 'thumb_height', label: t('Altezza miniatura'), type: 'range', min: 32, max: 120, step: 4,
      show: s => s.show_thumbnail !== false },
    withHover({ key: 'thumb_radius', label: t('Raggio miniatura'), type: 'border-radius',
      show: s => s.show_thumbnail !== false }),
