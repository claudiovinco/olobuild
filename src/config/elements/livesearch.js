...
export default {
  ...
  fields: [
    ...
    { key: 'debounce_ms', label: t('Debounce'), type: 'range', min: 100, max: 800, step: 50 },
  ...
  styleFields: [
    ...
    { key: 'modal_width', label: t('Larghezza modale'), type: 'range', min: 400, max: 800, step: 20,
      show: s => s.mode === 'modal' },
    ...
    { key: 'input_height', label: t('Altezza input'), type: 'range', min: 32, max: 72, step: 2 },
    withHover({ key: 'input_border_radius', label: t('Raggio input (px)'), type: 'border-radius' }),
    ...
    withHover({ key: 'results_border_radius', label: t('Raggio popup (px)'), type: 'border-radius' }),
    { key: 'item_hover_bg', label: t('Sfondo hover elemento'), type: 'color' },
    { key: 'results_max_height', label: t('Altezza max popup'), type: 'range', min: 200, max: 800, step: 20 },
    { key: 'thumb_width', label: t('Larghezza miniatura'), type: 'range', min: 32, max: 120, step: 4,
      show: s => s.show_thumbnail !== false },
    { key: 'thumb_height', label: t('Altezza miniatura'), type: 'range', min: 32, max: 120, step: 4,
      show: s => s.show_thumbnail !== false },
    withHover({ key: 'thumb_radius', label: t('Raggio miniatura (px)'), type: 'border-radius',
      show: s => s.show_thumbnail !== false }),
