...
export default {
  ...
  fields: [
    ...
    { key: 'front_image_fit', label: 'Adattamento immagine', type: 'select', options: [
      { value: 'cover', label: 'Copri (taglia)' },
      { value: 'contain', label: 'Contieni (intera)' },
    ...
    { key: 'back_image_fit', label: 'Adattamento immagine', type: 'select', options: [
      { value: 'cover', label: 'Copri (taglia)' },
      { value: 'contain', label: 'Contieni (intera)' },
      { value: 'fill', label: 'Riempi (deforma)' },
