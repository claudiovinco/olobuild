...
export default {
  ...
  defaults: {
    ...
    glow_on: true, glow_color: 'var(--olo-color-info, #2563eb)',
    ...
    bg_color: 'var(--olo-color-dark, #16263d)', panel_color: 'var(--olo-color-dark, #16263d)', panel2_color: 'var(--olo-color-dark, #16263d)', cell_color: 'var(--olo-color-text, #1f2937)',
    accent: 'var(--olo-color-info, #2563eb)', accent2: 'var(--olo-color-accent, #f4a23b)', accent_on: 'var(--olo-color-light, #f8f9fa)', down_color: '',
    text_color: 'var(--olo-color-light, #f8f9fa)', sub_color: 'var(--olo-color-text-soft, #6b7280)', pill_text_color: 'var(--olo-color-light, #f8f9fa)',
