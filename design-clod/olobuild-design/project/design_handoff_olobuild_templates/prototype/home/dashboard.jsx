...
function HomeTopBar({ crumb }) {
  const trail = crumb || (<span>Olobuild · <b>Dashboard</b></span>);
  return (
    <div className="home-bar">
      ...
      <button className="ico-btn" title="Profilo">
        <span style={{width:22,height:22,borderRadius:99,background:"linear-gradient(135deg,#e1474f,#ec5a62)",color:"#fff",display:"grid",placeItems:"center",fontSize:10,fontWeight:700}}>MA</span>
      </button>
    </div>
  );
}
...
Object.assign(window, { HomeDashboard, HomeTopBar, AppBackStrip });
