...
(() => {
  ...
  const stylesheet =
    ...
    '  background:#fff;box-shadow:0 0 0 1.5px var(--slot-accent,#c96442),0 1px 3px rgba(0,0,0,.3);' +
    ...
    ':host([data-reframe]) .frame{box-shadow:0 0 0 2px var(--slot-accent,#c96442)}' +
    ...
    '.empty:hover .sub u{color:var(--slot-fg-strong,rgba(0,0,0,.75));text-decoration-color:currentColor}' +
    ':host([data-over]) .frame{outline:2px solid var(--slot-accent,#c96442);outline-offset:-2px;' +
    '  background:var(--slot-over-bg,rgba(201,100,66,.10))}' +
    '.ring{position:absolute;inset:0;pointer-events:none;border:1.5px dashed var(--slot-ring,rgba(0,0,0,.25));' +
    '  transition:border-color .12s}' +
    ':host([data-over]) .ring{border-color:var(--slot-accent,#c96442)}' +
