      ...
      <div className="bui-right scrolly">
        ...
        <div className="field"><label>Sfondo</label>
          <div className="swatches">
            ...
            <span style={{background:"linear-gradient(135deg,#1e3a12,#4a8c2a)", boxShadow:"0 0 0 2px var(--ot-primary)"}}/>
...
function startElementDrag(e, label) {
  ...
  img.style.cssText = "position:absolute;top:-1000px;padding:6px 10px;background:#fff;border:1px solid #4a8c2a;border-radius:8px;font:500 12px Work Sans;color:#1e293b;box-shadow:0 8px 20px rgba(74,140,42,.25)";
