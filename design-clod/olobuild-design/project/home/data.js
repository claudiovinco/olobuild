...
const HOME_RECENT = [
  ...
  { id: "r3", title: "Header globale v2",    type: "Template", time: "3 ore fa", thumb: "linear-gradient(135deg,#fde2e4,#e1474f)" },
...
const HOME_LEARN = [
  { id: "l1", title: "Onboarding 60 secondi",    duration: "1:02", thumb: "linear-gradient(135deg,#e1474f,#ec5a62)", iconBg: "🚀" },
