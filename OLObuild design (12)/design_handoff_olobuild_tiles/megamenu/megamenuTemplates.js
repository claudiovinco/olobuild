 ...
 *
 * COME COMUNICARLI A OLObuild / applicarli:
 *   import { MEGAMENU_TEMPLATES } from '@/config/megamenuTemplates';
 *   const tpl = MEGAMENU_TEMPLATES.find(t => t.id === 'cinema-amber');
 *   Object.assign(elementSettings, structuredClone(tpl.settings)); // valori sovrascrivibili
 *
 * REGOLE rispettate:
 ...
 *  - `_frontend`: estensione CSS/JS da aggiungere al render del componente (NON è una
 *    chiave salvata; è una nota per chi implementa). I 12 `preset` ufficiali esistenti
 *    sono valorizzati nel campo `preset`; i bespoke usano `preset: 'custom'`.
 *
 * Helper formati:
 */
...
export const MEGAMENU_TEMPLATES = [
  ...
  { id:'tech-saas', name:'Tech SaaS', family:'A', preset:'gradient-bar',
    ...
    _frontend:'Badge "NEW" su una voce: oggi non c\'è una chiave; aggiungere supporto a un badge per item (es. da classe CSS della voce menu WP).' },
  ...
  { id:'editorial-hairline', name:'Editorial Hairline', family:'A', preset:'minimal-line',
    ...
    settings:{
      ...
      hover_effect:'underline', // “center” reso dal preset minimal-line nel frontend
  ...
  { id:'search-overlay', name:'Search Overlay', family:'E', preset:'custom',
    ...
    _frontend:'search_style “overlay” da rendere (campo a tutta barra + scorciatoia “/”).' },
  ...
  { id:'command-palette', name:'Command Palette', family:'F', preset:'custom',
    ...
    settings:{
      active_color:'#6d28d9', search_icon:true, search_position:'navbar', search_style:'overlay',
      button_mode:'last', btn_bg:'#6d28d9', btn_radius:R(10),
    },
    _frontend:'Pattern command-palette: input centrale + dropdown risultati (estensione del render ricerca). Probabilmente un nuovo search_style "command".' },
  ...
  { id:'mosaic-mega', name:'Mosaic Mega', family:'F', preset:'modern-clean',
    ...
    _frontend:'Tipo-colonna “immagini/promo” nel megapanel-map (griglia di thumbnail + card in evidenza). È l\'implementazione #5 del deep-dive.' },
