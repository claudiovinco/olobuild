export default {
  ...
  fields: [
    ...
    // --- Cerca nel menu ---
    { key: '_separator_search', label: 'Cerca nel menu', type: 'separator' },
    { key: 'append_search', label: 'Aggiungi ricerca', type: 'toggle' },
    { key: 'search_mode', label: 'Modalità ricerca', type: 'select',
      show: s => !!s.append_search,
      options: [
        { value: 'modal', label: 'Modale (popup centrato)' },
        { value: 'compact', label: 'Compatta (icona → campo)' },
      ]},
    { key: 'search_placeholder', label: 'Placeholder', type: 'text',
      show: s => !!s.append_search },
    { key: 'search_post_types', label: 'Tipi di contenuto', type: 'multi_pills',
      show: s => !!s.append_search,
      options: [
    ...
    { key: 'search_max_results', label: 'Max risultati', type: 'range',
      show: s => !!s.append_search,
      min: 3, max: 30, step: 1 },
    // Stile ricerca (mega menu / mobile)
    { key: '_separator_search_style', label: 'Stile ricerca (mega/mobile)', type: 'separator',
      show: s => !!s.append_search },
    { key: 'search_input_bg', label: 'Sfondo input', type: 'color',
      show: s => !!s.append_search },
    { key: 'search_input_color', label: 'Colore testo', type: 'color',
      show: s => !!s.append_search },
    { key: 'search_icon_color', label: 'Colore icona', type: 'color',
      show: s => !!s.append_search },
    { key: 'search_border_color', label: 'Colore bordo', type: 'color',
      show: s => !!s.append_search },
    { key: 'search_input_height', label: 'Altezza input (px)', type: 'range',
      show: s => !!s.append_search,
      min: 28, max: 52, step: 2 },
    { key: 'search_results_bg', label: 'Sfondo risultati', type: 'color',
      show: s => !!s.append_search },
    { key: 'search_hover_bg', label: 'Sfondo hover risultato', type: 'color',
      show: s => !!s.append_search },
    // --- Mobile ---
