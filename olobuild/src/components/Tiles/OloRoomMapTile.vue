  ...
  <div :style="wrapStyle">
    <div :style="mapStyle">
      ...
      <div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-100%);z-index:2">
        <svg width="32" height="42" viewBox="0 0 32 42"><path d="M16 0C7.2 0 0 7.2 0 16c0 12 16 26 16 26s16-14 16-26C32 7.2 24.8 0 16 0z" fill="#ef4444"/><circle cx="16" cy="14" r="6" fill="#fff"/></svg>
      </div>
      <div style="position:absolute;bottom:8px;left:8px;background:rgba(255,255,255,.9);padding:3px 8px;border-radius:4px;font-size:10px;color:#374151;z-index:2">Zoom: {{ s.zoom || 16 }}</div>
    </div>
  </div>
</template>
