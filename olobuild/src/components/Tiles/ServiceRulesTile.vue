  ...
  <div :style="wrapStyle">
    <div v-if="s.show_title" style="display:flex;align-items:center;gap:6px;margin-bottom:6px">
      <svg v-if="s.show_icon" :width="titleSz+2" :height="titleSz+2" viewBox="0 0 24 24" fill="none">
        <path d="M12 2L4 5v6.09c0 5.05 3.41 9.76 8 10.91 4.59-1.15 8-5.86 8-10.91V5l-8-3z" :stroke="s.icon_color" stroke-width="1.8" stroke-linejoin="round" :fill="s.icon_color" fill-opacity="0.1"/>
        <path d="M9 12l2 2 4-4" :stroke="s.icon_color" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
      <span :style="{fontSize:titleSz+'px',fontWeight:'700',color:s.title_color}">{{ s.title_text || 'Regole della struttura' }}</span>
    </div>
...
const defaults = {
  ...
  title_size: '18', text_size: '14', title_color: '#1F2937', text_color: '#374151', icon_color: '#DC2626',
