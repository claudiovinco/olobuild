...
(function () {
  ...
  var CSS = [
    ...
    '.olo-pdfv-toolbar button.olo-pdfv-active { background:rgba(225,71,79,.15); background:color-mix(in srgb, var(--olo-color-primary, #e1474f) 15%, transparent); color:var(--olo-color-primary, #e1474f); }',
