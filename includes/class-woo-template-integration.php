...
class Olo_Woo_Template_Integration {
    ...
    public function render_admin_page() {
        ...
        <main class="olo-cockpit-main olo-cockpit-legacy">
            <?php
            // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- HTML generated by Olo_Builder::cockpit_page_head(), which escapes title/sub internally (esc_html/wp_kses_post); the dynamic counts injected here are (int)-cast.
