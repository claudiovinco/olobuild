...
class Olobuild_Woo_Template_Integration {
    ...
    private function get_olo_wrapper_template( $template_id ) {
        $wrapper = OLOBUILD_PATH . 'templates/woo-olo-wrapper.php';
    ...
    public function render_admin_page() {
        ...
        <main class="olo-cockpit-main olo-cockpit-legacy">
            <?php
            // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped -- HTML generated by Olobuild_Builder::cockpit_page_head(), which escapes title/sub internally (esc_html/wp_kses_post); the dynamic counts injected here are (int)-cast.
