...
class Olobuild_Role_Manager {
    ...
    public function render_admin_page() {
        ...
        <main class="olo-cockpit-main olo-cockpit-legacy">
            <?php
            // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped -- HTML generated by Olo_Builder::cockpit_page_head(), which escapes title via esc_html() and sub via wp_kses_post() internally; the sub markup only interpolates (int) casts.
