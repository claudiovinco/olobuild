...
class Olo_FlipCard_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        ob_start();
        ?>
        <?php // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped -- inline CSS below is built exclusively from values sanitized above: intval()/absint() for all sizes and durations, safe_color_css() whitelist for every colour, in_array() whitelists for direction/trigger/alignments, esc_attr() for easing, Olo_Tile_Utils helpers (border_radius/radius_force_css/shadow_value/spacing_css) and fixed transform strings from internal switch maps. ?>
        <style>
            .<?php echo $uid; ?> {
        ...
        <div class="olo-fc <?php echo esc_attr( $uid ); ?> olo-fc-preset-<?php echo esc_attr( sanitize_key( $s['preset'] ?? 'custom' ) ); ?>" data-trigger="<?php echo esc_attr( $trigger ); ?>">
            <div class="olo-fc-inner">
                <div class="olo-fc-front">
                    <?php echo $this->render_face( $s, 'front' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- markup generated by render_face() which escapes every value internally (esc_html/esc_attr/esc_url/safe_color_css/Olo_Tile_Utils::img_srcset) ?>
                </div>
                <div class="olo-fc-back">
                    <?php echo $this->render_face( $s, 'back' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- markup generated by render_face() which escapes every value internally (esc_html/esc_attr/esc_url/safe_color_css/Olo_Tile_Utils::img_srcset) ?>
                </div>
            </div>
        </div>
        <script>
        ...
        if ( $border_css || $border_hover_css || $border_effect_css || $card_border_hover_css ) {
            ...
            echo $border_hover_css . $border_effect_css; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CSS generated by Olo_Tile_Base::build_border_hover_css()/build_border_effect_css() shared helpers
            echo $card_border_hover_css . '</style>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CSS generated by Olo_Tile_Base::build_border_hover_css() shared helper
        }
