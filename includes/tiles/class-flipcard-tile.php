        ...
        <div class="olo-fc <?php echo esc_attr( $uid ); ?> olo-fc-preset-<?php echo esc_attr( sanitize_key( $s['preset'] ?? 'custom' ) ); ?>" data-trigger="<?php echo esc_attr( $trigger ); ?>">
            <div class="olo-fc-inner">
                <div class="olo-fc-front">
                    <?php echo $this->render_face( $s, 'front' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- markup generated by render_face() which escapes every value internally (esc_html/esc_attr/esc_url/safe_color_css/Olobuild_Tile_Utils::img_srcset) ?>
                </div>
                <div class="olo-fc-back">
                    <?php echo $this->render_face( $s, 'back' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- markup generated by render_face() which escapes every value internally (esc_html/esc_attr/esc_url/safe_color_css/Olobuild_Tile_Utils::img_srcset) ?>
                </div>
            </div>
        </div>
        <script>
