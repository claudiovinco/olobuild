...
class Olobuild_IconTabs_Tile extends Olobuild_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        if ( $border_css || $border_hover_css || $border_effect_css || $card_border_css || $card_border_hover_css ) {
            ...
            echo $card_border_hover_css . '</style>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CSS generated by Olobuild_Tile_Base::build_border_hover_css() from sanitized card border settings
        }
        return ob_get_clean();
    }
}
