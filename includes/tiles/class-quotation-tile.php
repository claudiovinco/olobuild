...
class Olobuild_Quotation_Tile extends Olobuild_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        if ( $border_css || $border_hover_css || $border_effect_css ) {
            echo '<style>';
            if ( $border_css ) echo ".{$quot_uid}{{$border_css}}"; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CSS generated by Olobuild_Tile_Base::build_border_css() from sanitized settings; $quot_uid is internally generated
