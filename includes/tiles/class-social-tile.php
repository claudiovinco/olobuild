...
class Olobuild_Social_Tile extends Olobuild_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        ob_start();
        ?>
        <?php // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped -- inline CSS below is fixed literals selected by PHP conditionals; $uid is internally generated. ?>
        <style>
        ...
        <div id="<?php echo esc_attr( $uid ); ?>" class="olo-social uk-flex uk-flex-wrap <?php echo esc_attr( $align_class ); ?>" style="gap: <?php echo (int) $gap; ?>px; padding: 16px;">
