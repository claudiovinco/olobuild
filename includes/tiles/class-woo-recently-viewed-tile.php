...
class Olo_Woo_Recently_Viewed_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        <h3 class="<?php echo esc_attr( $uid ); ?>-heading<?php echo $rv_cls; ?>"<?php echo $rv_data; ?>><?php echo esc_html( $heading_text ); ?></h3>
        <?php endif; ?>
        ...
        ?>
            <div class="olo-rv-card">
                ...
                <div class="olo-rv-card-body">
                    ...
                    <div class="olo-rv-card-price"><?php echo $price_html; ?></div>
                    <?php endif; ?>
