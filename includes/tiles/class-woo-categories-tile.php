...
class Olo_Woo_Categories_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        ob_start();
        ?>
        <?php // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped -- inline CSS below is built exclusively from values sanitized above: absint() clamps for columns/gap, Olo_Tile_Utils radius helpers, safe_color_css()/esc_attr()'d colors, fixed ratio map, in_array() whitelisted tag and the internally generated $uid. ?>
        <style>
