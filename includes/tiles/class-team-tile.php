            ...
            <div class="olo-team-info-wrap">
                <div class="olo-team-info">
                    ...
                    <?php if ( ! empty( $s['link_url'] ) ) : ?>
                        <a href="<?php echo esc_url( $s['link_url'] ); ?>" class="olo-team-link"><?php echo $link_text; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- escaped via esc_html() at assignment above ?> &rarr;</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
