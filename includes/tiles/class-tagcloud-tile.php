...
class Olo_Tagcloud_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        ob_start();
        ?>
        <?php // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped -- inline CSS below is built exclusively from values sanitized above: colours via the safe_color_css() whitelist (with fixed var() fallbacks), radius via Olo_Tile_Utils absint helpers, padding integer-forced or character-whitelisted, font-weight via in_array() whitelist, underline a fixed-literal ternary; $uid is internally generated. ?>
        <style>
