...
class Olo_Videoplaylist_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        <div class="<?php echo esc_attr( $uid ); ?>" id="<?php echo esc_attr( $uid ); ?>">
            ...
            <!-- Sidebar / Playlist -->
            <div class="olo-vp-sidebar" role="list" aria-label="<?php echo esc_attr( olo_t( 'Playlist video', 'olobuilder' ) ); ?>">
    ...
    private function get_player_html( $url, $title = '' ) {
        ...
        $title_attr = ' title="' . esc_attr( $title !== '' ? $title : olo_t( 'Video', 'olobuilder' ) ) . '"';
