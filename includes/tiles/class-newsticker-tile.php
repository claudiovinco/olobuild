...
class Olobuild_Newsticker_Tile extends Olobuild_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        if ( $border_css || $border_hover_css || $border_effect_css || $radius_css || $radius_hover_css ) {
            ...
            echo $border_hover_css . $border_effect_css . $radius_hover_css . '</style>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CSS generated by Olobuild_Tile_Base border/hover helpers from sanitized settings
        }
        return ob_get_clean();
    }
}
