...
class Olo_Testimonial_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        if ( $border_css || $border_hover_css || $border_effect_css || $card_border_hover_css ) {
            ...
            echo $border_hover_css . $border_effect_css . $card_border_hover_css . '</style>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CSS generated by Olo_Tile_Base border helpers from sanitized border settings
        }
    ...
    private function render_common_styles( $uid, $bg, $fg, $line_col, $show_line, $is_bottom, $position, $av_size, $av_radius, $tile_radius, $tile_radius_hover_css, $bottom_jc, $s ) {
        // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped -- inline CSS below is built exclusively from values sanitized in render() (safe_color_css() whitelist for colors, intval() ints, Olo_Tile_Utils border_radius/radius_force_css/shadow helpers, fixed literal maps/ternaries) and the internally generated $uid.
        ?>
        <style>
