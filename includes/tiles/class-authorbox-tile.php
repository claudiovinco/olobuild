...
class Olobuild_Authorbox_Tile extends Olobuild_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        $gap        = absint( $s['gap'] );
        $padding = Olobuild_Tile_Utils::spacing_css( $s['tile_padding'] ?? $s['padding'] ?? 20, 20 );
        ...
        <div class="olo-authorbox <?php echo esc_attr( $uid ); ?>">
            <div class="olo-ab-layout">
                ...
                <div class="olo-ab-info">
                    ...
                    <?php if ( $show_count ) : ?>
                    <div class="olo-ab-count"><?php echo esc_html( $post_count . ' ' . olobuild_t( 'articoli pubblicati' ) ); ?></div>
                    <?php endif; ?>
