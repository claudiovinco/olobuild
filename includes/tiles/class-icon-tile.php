...
class Olobuild_Icon_Tile extends Olobuild_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        ob_start();
        if ( $anim_css ) {
            echo '<style>' . $anim_css . '</style>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- keyframe CSS from fixed literals scoped to the internally generated $uid
        }
        ?>
