...
class Olobuild_PanelSlider_Tile extends Olobuild_Tile_Base {
    ...
    // ora centralizzati in Olobuild_Tile_Base (ereditati).
    ...
    private function build_scoped_css( $uid, $s ) {
        ...
        $padding          = Olobuild_Tile_Utils::spacing_css( $s['card_padding'] ?? 24, 24 );
