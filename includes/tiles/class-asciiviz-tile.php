 ...
 */
class Olo_Asciiviz_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        <div class="<?php echo esc_attr( $uid ); ?>-wrap olo-asciiviz"
            ...
            <?php if ( $audio_url !== '' ) : ?>
            <audio id="<?php echo esc_attr( $uid ); ?>-audio" src="<?php echo $audio_url; ?>" preload="none" crossorigin="anonymous" loop<?php echo $autoplay ? ' autoplay' : ''; ?>></audio>
            <?php endif; ?>
            <?php if ( $show_player ) : ?>
            <div class="<?php echo esc_attr( $uid ); ?>-bar">
                <button type="button" class="<?php echo esc_attr( $uid ); ?>-play" id="<?php echo esc_attr( $uid ); ?>-play"
                        aria-label="<?php echo esc_attr( olo_t( 'Riproduci / Pausa' ) ); ?>" aria-pressed="false">
                ...
                <div class="<?php echo esc_attr( $uid ); ?>-np">
                    <?php if ( $track_label !== '' ) : ?><div class="lab"><?php echo $track_label; ?></div><?php endif; ?>
                    <div class="tr"><?php echo $track_name; ?></div>
                    <div class="state" id="<?php echo esc_attr( $uid ); ?>-state" role="status" aria-live="polite"><?php echo esc_html( olo_t( 'in pausa · premi play' ) ); ?></div>
                    <?php if ( $show_progress ) : ?>
                ...
                <div class="<?php echo esc_attr( $uid ); ?>-list">
                    ...
                    <b id="<?php echo esc_attr( $uid ); ?>-lcount"><?php echo esc_html( number_format_i18n( $list_base ) ); ?></b>&nbsp;<?php echo $list_label; ?>
                </div>
                <?php endif; ?>
            </div>
            <?php endif; ?>
        ...
        if ( $border_css || $border_hover_css || $border_effect_css ) {
            echo '<style>';
            if ( $border_css ) echo "{$sel}{{$border_css}}";
