...
class Olobuild_Pagination_Tile extends Olobuild_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        $prev_text   = esc_html( $s['prev_text'] ?: olobuild_t( "\xC2\xAB Precedente" ) );
        $next_text   = esc_html( $s['next_text'] ?: olobuild_t( "Successivo \xC2\xBB" ) );
        ...
        if ( is_array( $s['button_padding'] ) ) {
            $padding_css = Olobuild_Tile_Utils::spacing_css( $s['button_padding'] );
        } else {
