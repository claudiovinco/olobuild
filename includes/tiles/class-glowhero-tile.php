...
class Olobuild_GlowHero_Tile extends Olobuild_Tile_Base {
    ...
    protected $defaults = [
        ...
        'show_scroll'    => true,
        // Aspetto / glow
        'bg_color'       => 'var(--olo-color-dark, #0a0a0c)',
        'accent'         => '',
        'accent2'        => '',
        'accent_on'      => 'var(--olo-color-dark, #0a0a0c)',
        'text_color'     => 'var(--olo-color-light, #ece9e3)',
        'sub_color'      => 'var(--olo-color-text-faint, #9b988f)',
        'eyebrow_color'  => 'var(--olo-color-text-faint, #9b988f)',
