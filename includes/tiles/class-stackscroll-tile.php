 ...
 */
class Olo_Stackscroll_Tile extends Olo_Tile_Base {
    ...
    protected function stack_shadow_css( $s ) {
        ...
        $map = [
            ...
            'xl' => '0 20px 45px rgba(0,0,0,0.20)',
        ];
        if ( isset( $map[ $val ] ) ) {
            return $map[ $val ];
        }
    ...
    public function render( $settings ) {
        ...
        <div class="olo-stack <?php echo esc_attr( $uid ); ?>">
            <div class="olo-stack__list" role="list">
                <?php if ( $total === 0 ) : ?>
                    <div class="scard" style="top:<?php echo $top_offset; ?>px;" role="listitem">
                    ...
                    ?>
                        <div class="scard scard--<?php echo intval( $i ); ?>" style="<?php echo esc_attr( $card_style ); ?>" role="listitem">
                            <div class="scard__txt">
                                ...
                                <?php endif; ?>
                                <?php if ( $text_html !== '' ) : ?>
                                    <div class="scard__text" data-olo-editable="cards.<?php echo intval( $i ); ?>.text" data-olo-richtext><?php echo $text_html; ?></div>
                                <?php endif; ?>
                            </div>
                            <?php if ( $has_media ) : ?>
        ...
        if ( $border_css || $border_hover_css || $border_effect_css ) {
            echo '<style>';
            if ( $border_css ) { echo "{$card_sel}{{$border_css}}"; }
