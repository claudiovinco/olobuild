...
class Olobuild_SwitcherPanel_Tile extends Olobuild_Tile_Base {
    ...
    protected $defaults = [
        ...
        'nav_active_color'      => 'var(--olo-color-light, #ffffff)',
        'nav_inactive_color'    => 'rgba(255,255,255,0.65)',
        'nav_hover_bg'          => 'transparent',
        'nav_indicator_type'    => 'underline',
        'nav_indicator_color'   => 'var(--olo-color-light, #ffffff)',
        'nav_indicator_thickness' => 2,

        'panel_bg'              => 'var(--olo-color-light, #ffffff)',
        'panel_text_color'      => 'var(--olo-color-dark, #1e293b)',
        'panel_title_color'     => 'var(--olo-color-dark, #0f172a)',
        'panel_title_size'      => 28,
    ...
    public function render( $settings ) {
        ...
        $padding      = Olobuild_Tile_Utils::spacing_css( $s['tile_padding'] ?? 40, 40 );
