...
class Olobuild_Woo_Product_Navigation_Tile extends Olobuild_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        ob_start();
        // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped -- inline CSS below is built exclusively from values sanitized above: $text_color/$hover_color via the safe_color_css() whitelist, $sep_style from a fixed literal map; $uid is internally generated.
        ?>
        <style>
            .<?php echo $uid; ?> {
                display: flex;
