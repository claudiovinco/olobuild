...
class Olobuild_NorthQuoteSlider_Tile extends Olobuild_Tile_Base {
    ...
    protected $defaults = [
        ...
        'quote_color'        => 'var(--olo-color-text, #212121)',
        'author_color'       => 'var(--olo-color-text, #212121)',
        'role_color'         => 'var(--olo-color-text-soft, #6B7280)',
        'logo_color'         => 'var(--olo-color-text, #062C22)',
        'arrow_color'        => 'var(--olo-color-text, #212121)',
        'graphic_color'      => 'var(--olo-color-text, #0A2E22)',
        'graphic_line_color' => 'var(--olo-color-accent, #9DF5D6)',
        'quote_size'         => 26,
