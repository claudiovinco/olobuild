...
class Olo_Sitemap_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        <?php if ( $extra ) echo '<style>' . $extra . '</style>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CSS generated by Olo_Tile_Base::build_wow_effects_css() from clamped numbers, whitelisted enums and safe_color_css() colors (get_preset_extra_css() returns '') ?>
