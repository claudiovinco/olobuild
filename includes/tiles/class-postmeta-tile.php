...
class Olo_PostMeta_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        if ( $extra ) {
            echo '<style>' . $extra . '</style>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CSS generated by Olo_Tile_Base::build_wow_effects_css() from clamped numerics and whitelisted enums
        }
