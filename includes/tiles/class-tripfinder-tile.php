 ...
 */
class Olo_TripFinder_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings, $style = [] ) {
        ...
        ob_start();
        ?>
        <?php // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped -- inline CSS below is built exclusively from values sanitized above: every colour via the safe_color_css() whitelist (with fixed var() fallbacks), radius/padding via intval() helpers, box decorations via the Olo_CSS_Builder/Olo_Tile_Base shared helpers (sanitized internally), fixed font-stack literal; $uid is internally generated. ?>
        <style>
