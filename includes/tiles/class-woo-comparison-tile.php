...
class Olobuild_Woo_Comparison_Tile extends Olobuild_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        ob_start();
        ?>
        <?php // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped -- inline CSS below is built exclusively from values sanitized above: every colour via the safe_color_css() whitelist (or fixed var() fallback literals); $uid is internally generated. ?>
        <style>
        ...
        <div id="<?php echo esc_attr( $uid ); ?>" class="olo-woo-comparison" data-max="<?php echo (int) $max; ?>">
            <div class="cmp-empty" id="<?php echo esc_attr( $uid ); ?>-empty"><?php echo $empty_text; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- $empty_text is esc_html()'d above ?></div>
            <div id="<?php echo esc_attr( $uid ); ?>-table" style="display:none"></div>
        </div>
