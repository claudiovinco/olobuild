...
class Olo_Queryloop_Tile extends Olo_Tile_Base {
    ...
    private function render_card( $post_obj, $s ) {
        ...
        <article class="<?php echo esc_attr( implode( ' ', $card_classes ) ); ?>"<?php if ( ! empty( $card_styles ) ) echo ' style="' . esc_attr( implode( ';', $card_styles ) ) . '"'; ?><?php echo $hover_attr; ?>>
            <?php if ( $is_new ) : ?><span class="olo-ql-new-badge"><?php echo $new_text; ?></span><?php endif; ?>
            ...
            <div class="olo-ql-body">
                ...
                <?php if ( ! empty( $s['show_date'] ) || ! empty( $s['show_author'] ) || $reading_time || $comment_cnt > 0 ) : ?>
                    <div class="olo-ql-meta"<?php if ( ! empty( $s['meta_color'] ) ) echo ' style="color:' . esc_attr( $s['meta_color'] ) . '"'; ?>>
                        ...
                        <?php endif; ?>
                        <?php if ( $reading_time ) : ?>
                            <span class="olo-ql-rt"><?php echo $reading_time; ?> min</span>
                        <?php endif; ?>
                        <?php if ( $comment_cnt > 0 ) : ?>
                            <span class="olo-ql-cc"><?php echo $comment_cnt; ?></span>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
                    ...
                    ?>
                        <div class="olo-ql-tl-group">
                            ...
                            <div class="olo-ql-tl-items">
                                <?php echo $this->render_cards( $posts, $s ); ?>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
