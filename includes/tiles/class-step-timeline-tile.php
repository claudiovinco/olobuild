...
class Olobuild_StepTimeline_Tile extends Olobuild_Tile_Base {
    ...
    protected $defaults = [
        'items' => [
            [ 'counter' => '01', 'tag_text' => 'PRONTO IN 30"', 'tag_dot_color' => 'var(--olo-color-primary, #b3261e)', 'media_label' => 'TERMINAL · INSTALL', 'media_type' => 'terminal', 'media_content' => "# installazione\n$ wp plugin install olobuild --activate\n✓ Plugin installato\n✓ 187 tile registrati\n# pronto\n$", 'media_image' => '', 'media_bg' => 'var(--olo-color-text, #0f172a)', 'media_color' => 'var(--olo-color-primary, #10b981)', 'pre_title' => 'INSTALLA', 'title' => 'Scarichi', 'title_accent' => 'OLObuild', 'title_accent_italic' => true, 'title_after' => 'direttamente da WordPress.org.', 'title_after_italic' => false, 'description' => 'Zero configurazione obbligatoria. Funziona con qualunque tema WP. Anche dal nostro sito al lancio — un click e sei dentro.', 'footer_value' => '30"', 'footer_label' => 'TEMPO MEDIO', 'separator_text' => '→ POI' ],
            [ 'counter' => '02', 'tag_text' => 'DRAG & DROP', 'tag_dot_color' => '#b3261e', 'media_label' => 'OLOBUILD · EDITOR LIVE', 'media_type' => 'placeholder', 'media_content' => '', 'media_image' => '', 'media_bg' => 'var(--olo-color-text, #f5efe7)', 'media_color' => 'var(--olo-color-primary, #b3261e)', 'pre_title' => 'COSTRUISCI', 'title' => 'Trascini i tile, scegli i colori,', 'title_accent' => 'doppio click', 'title_accent_italic' => true, 'title_after' => 'per editare.', 'title_after_italic' => false, 'description' => 'Anteprima fedele in tempo reale. Mobile, tablet, desktop con un click. Niente shortcode, niente "preview separato".', 'footer_value' => '≈ 1h', 'footer_label' => 'PRIMA PAGINA', 'separator_text' => '→ VAI LIVE' ],
            [ 'counter' => '03', 'tag_text' => 'ONLINE', 'tag_dot_color' => 'var(--olo-color-primary, #10b981)', 'media_label' => 'TUOSITO.COM · LIVE', 'media_type' => 'placeholder', 'media_content' => '', 'media_image' => '', 'media_bg' => '#f5efe7', 'media_color' => '#10b981', 'pre_title' => 'PUBBLICHI & SCALI', 'title' => 'Quando ti serve,', 'title_accent' => 'aggiungi', 'title_accent_italic' => true, 'title_after' => 'OLOlang o OLObooking.', 'title_after_italic' => false, 'description' => 'Stesso stack, stessa interfaccia, niente migration. Pronto al traffico — i pezzi crescono insieme al sito.', 'footer_value' => '0"', 'footer_label' => 'PRONTO AL TRAFFICO', 'separator_text' => '' ],
        ],
