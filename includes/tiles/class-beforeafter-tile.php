    ...
    public function render( $settings, $style = [] ) {
        ...
        <div class="olo-beforeafter <?php echo esc_attr( $uid ); ?>">
            ...
            ?>
                <div class="oba-card">
                    <div class="oba-pair">
                        <div class="oba-media"<?php echo $bsty; ?>><?php if ( ! empty( $it['before_label'] ) ) : ?><span class="oba-lab oba-lab--b"><?php echo esc_html( $it['before_label'] ); ?></span><?php endif; ?></div>
                        <div class="oba-media"<?php echo $asty; ?>><?php if ( ! empty( $it['after_label'] ) ) : ?><span class="oba-lab oba-lab--a"><?php echo esc_html( $it['after_label'] ); ?></span><?php endif; ?></div>
                    </div>
