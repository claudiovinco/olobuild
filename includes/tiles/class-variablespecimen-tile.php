...
class Olo_Variablespecimen_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        <div class="olo-vf <?php echo esc_attr( $uid ); ?>" data-interaction="<?php echo esc_attr( $interaction ); ?>">
            ...
            <?php if ( $has_drag ) : ?>
            <div class="olo-vf-hint"><?php echo $drag_hint; ?></div>
            <?php endif; ?>
        ...
        (function(){
            ...
            var AXES = <?php echo wp_json_encode( $axes_js ); ?>;
            ...
            var AUTO_SPEED = <?php echo wp_json_encode( $auto_speed ); ?>;
