...
class Olo_Carousel_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        <div class="olo-carousel <?php echo esc_attr( $uid ); ?>" id="<?php echo esc_attr( $uid ); ?>" data-slides="<?php echo $show; ?>" data-total="<?php echo $total; ?>" data-gap="<?php echo $gap; ?>">
        ...
        (function(){
            ...
            if(!track){return}
            var dotsWrap = document.getElementById('<?php echo $uid; ?>-dots');
