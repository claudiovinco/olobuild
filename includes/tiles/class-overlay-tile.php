...
class Olobuild_Overlay_Tile extends Olobuild_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        $radius_hover_css  = Olobuild_Tile_Utils::radius_hover_rules( "#{$id}", $s, 'border_radius_hover', Olobuild_Tile_Utils::transizione_di( $border_hover_css ) );
        if ( $border_css || $border_hover_css || $border_effect_css || $radius_hover_css ) {
            ...
            echo $border_hover_css . $border_effect_css . $radius_hover_css . '</style>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CSS generated by Olobuild_Tile_Base::build_border_hover_css()/build_border_effect_css() and Olobuild_Tile_Utils::radius_hover_rules() (integer px) from sanitized settings
        }
