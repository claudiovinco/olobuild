...
class Olobuild_PostGrid_Tile extends Olobuild_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        if ( ! $query->have_posts() ) {
            wp_reset_postdata();
            return '<p style="color:var(--olo-color-text-muted, #9CA3AF);text-align:center;">' . esc_html( olobuild_t( 'Nessun articolo trovato.' ) ) . '</p>';
        }
