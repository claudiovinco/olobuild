...
class Olo_Woo_Product_Bundle_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        ob_start();
        // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped -- inline CSS below is built exclusively from values sanitized above (safe_color_css(), absint(), Olo_Tile_Utils::border_radius()/radius_force_css(), fixed literal ternaries) and the internally generated $uid.
        ?>
        <style>
            .<?php echo $uid; ?> {
