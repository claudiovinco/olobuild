...
class Olo_Loginform_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        <style>
            .<?php echo $uid; ?> {
                ...
                <?php if ( $form_bw > 0 ) : ?>border: <?php echo (int) $form_bw; ?>px solid <?php echo $form_bc ?: $input_border_val; ?>;<?php endif; ?>
            }
            ...
            <div class="olo-lf-loggedin">
                <?php if ( $show_avatar ) : ?>
                    <div class="olo-lf-avatar">
                        <?php echo get_avatar( $current_user->ID, 64 ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- get_avatar() returns safe <img> markup generated by WordPress core ?>
                    </div>
                <?php endif; ?>
        ...
        <?php else : ?>
            ...
            <?php if ( $mode === 'both' ) : ?>
                <div class="olo-lf-tabs">
                    <button type="button" class="olo-lf-tab active" data-olo-tab="login" data-olo-uid="<?php echo esc_attr( $uid ); ?>"><?php echo esc_html( $login_btn_text ); ?></button>
                    <button type="button" class="olo-lf-tab" data-olo-tab="register" data-olo-uid="<?php echo esc_attr( $uid ); ?>"><?php echo esc_html( $register_btn_text ); ?></button>
                </div>
            <?php endif; ?>
            ...
            ?>
            <div class="olo-lf-panel<?php echo esc_attr( $login_active ); ?>" data-olo-panel="login" data-olo-uid="<?php echo esc_attr( $uid ); ?>">
                <!-- Header -->
                <?php if ( $login_title ) : ?>
                <div class="olo-lf-header">
                    <div class="olo-lf-title"><?php echo esc_html( $login_title ); ?></div>
                    <?php if ( $login_subtitle ) : ?><div class="olo-lf-subtitle"><?php echo esc_html( $login_subtitle ); ?></div><?php endif; ?>
                </div>
                <?php endif; ?>
            ...
            ?>
            <div class="olo-lf-panel<?php echo esc_attr( $reg_active ); ?>" data-olo-panel="register" data-olo-uid="<?php echo esc_attr( $uid ); ?>">
                <!-- Header -->
                <?php if ( $register_title ) : ?>
                <div class="olo-lf-header">
                    <div class="olo-lf-title"><?php echo esc_html( $register_title ); ?></div>
                    <?php if ( $register_subtitle ) : ?><div class="olo-lf-subtitle"><?php echo esc_html( $register_subtitle ); ?></div><?php endif; ?>
                </div>
                <?php endif; ?>
                ...
                <form method="post" class="olo-lf-form" data-olo-loginform="register" data-olo-uid="<?php echo esc_attr( $uid ); ?>">
                    ...
                    <div class="<?php echo esc_attr( $rf_width ); ?>">
                        <label class="olo-lf-label" for="<?php echo esc_attr( $uid ); ?>-reg-user"><?php echo esc_html( $rf_label . $req_star ); ?></label>
                        <div class="olo-lf-input-wrap">
                            <?php if ( $show_icons ) : ?><span class="olo-lf-icon"><?php echo $icon_user; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- static SVG markup defined above in this method ?></span><?php endif; ?>
                            <input type="text" id="<?php echo esc_attr( $uid ); ?>-reg-user" name="user_login" class="olo-lf-input" placeholder="<?php echo esc_attr( $rf_ph ); ?>"<?php echo esc_attr( $req_attr ); ?> autocomplete="username" />
                        </div>
                    </div>

                    <?php elseif ( $rf_type === 'user_email' ) : ?>
                    <div class="<?php echo esc_attr( $rf_width ); ?>">
                        <label class="olo-lf-label" for="<?php echo esc_attr( $uid ); ?>-reg-email"><?php echo esc_html( $rf_label . $req_star ); ?></label>
                        <div class="olo-lf-input-wrap">
                            <?php if ( $show_icons ) : ?><span class="olo-lf-icon"><?php echo $icon_mail; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- static SVG markup defined above in this method ?></span><?php endif; ?>
                            <input type="email" id="<?php echo esc_attr( $uid ); ?>-reg-email" name="user_email" class="olo-lf-input" placeholder="<?php echo esc_attr( $rf_ph ); ?>"<?php echo esc_attr( $req_attr ); ?> autocomplete="email" />
                        </div>
                    </div>

                    <?php elseif ( $rf_type === 'user_password' ) : ?>
                    <div class="<?php echo esc_attr( $rf_width ); ?>" style="margin-bottom:4px;">
                        <label class="olo-lf-label" for="<?php echo esc_attr( $uid ); ?>-reg-pass"><?php echo esc_html( $rf_label . $req_star ); ?></label>
                        <div class="olo-lf-input-wrap">
                            <?php if ( $show_icons ) : ?><span class="olo-lf-icon"><?php echo $icon_lock; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- static SVG markup defined above in this method ?></span><?php endif; ?>
                        ...
                        <div class="olo-lf-pw-reqs" style="margin-top:6px;">
                            ...
                            <div class="olo-lf-pw-req" data-met="0" style="display:flex;align-items:center;gap:6px;font-size:11px;margin-bottom:3px;color:<?php echo $text_color_val; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CSS color sanitized via safe_color_css() whitelist above ?>;opacity:0.6;">
                    ...
                    <div class="<?php echo esc_attr( $rf_width ); ?>">
                        <label class="olo-lf-label" for="<?php echo esc_attr( $uid ); ?>-reg-pass2"><?php echo esc_html( $rf_label . $req_star ); ?></label>
                        <div class="olo-lf-input-wrap">
                            <?php if ( $show_icons ) : ?><span class="olo-lf-icon"><?php echo $icon_lock; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- static SVG markup defined above in this method ?></span><?php endif; ?>
                            <input type="password" id="<?php echo esc_attr( $uid ); ?>-reg-pass2" name="user_pass_confirm" class="olo-lf-input" placeholder="<?php echo esc_attr( $rf_ph ); ?>"<?php echo esc_attr( $req_attr ); ?> autocomplete="new-password" />
                        </div>
                    </div>
                    ...
                    <div class="<?php echo esc_attr( $rf_width ); ?>">
                        <label class="olo-lf-option">
                            <input type="checkbox" name="olo_custom[<?php echo esc_attr( $cf_name ); ?>]" value="1"<?php echo esc_attr( $req_attr ); ?> />
                            <span><?php echo esc_html( $rf_ph ?: $rf_label ); ?></span>
                        </label>
                    </div>
                    ...
                    <label class="olo-lf-terms">
                        ...
                        <span>
                            <?php if ( $terms_url ) : ?>
                            <a href="<?php echo $terms_url; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- escaped via esc_url() at assignment above ?>" target="_blank"><?php echo esc_html( $terms_text ); ?></a>
                            <?php else : ?>
                    ...
                    <button type="submit" class="olo-lf-submit"><?php echo esc_html( $register_btn_text ); ?></button>
                </form>
                <?php else : ?>
                <p style="color:<?php echo $text_color_val; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CSS color sanitized via safe_color_css() whitelist above ?>;font-size:14px;text-align:center;padding:20px 0;">
    ...
    private function render_social_buttons( $s, $uid ) {
        ...
        <div class="olo-lf-divider">
            ...
            <span class="olo-lf-divider-text"><?php echo esc_html( $divider_text ); ?></span>
            <div class="olo-lf-divider-line"></div>
        </div>
        <?php
    }
