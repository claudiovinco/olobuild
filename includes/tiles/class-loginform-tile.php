...
class Olo_Loginform_Tile extends Olo_Tile_Base {
        ...
        if ( is_user_logged_in() ) :
            ...
            <div class="olo-lf-loggedin">
                ...
                <div style="margin-top:16px;">
                    <a href="<?php echo esc_url( $logout_url ); ?>" class="olo-lf-link">Esci</a>
                </div>
            </div>
        <?php else : ?>
                ...
                <form method="post" class="olo-lf-form" data-olo-loginform="login" data-olo-uid="<?php echo esc_attr( $uid ); ?>">
                    ...
                    <div class="olo-lf-field">
                        ...
                        <div class="olo-lf-input-wrap">
                            ...
                            <input type="text" id="<?php echo esc_attr( $uid ); ?>-user" name="log" class="olo-lf-input" placeholder="nome@esempio.it" required autocomplete="username" />
                        </div>
                    </div>
                    <div class="olo-lf-field">
                        <label class="olo-lf-label" for="<?php echo esc_attr( $uid ); ?>-pass">Password</label>
                        <div class="olo-lf-input-wrap">
                            <?php if ( $show_icons ) : ?><span class="olo-lf-icon"><?php echo $icon_lock; ?></span><?php endif; ?>
                            <input type="password" id="<?php echo esc_attr( $uid ); ?>-pass" name="pwd" class="olo-lf-input" placeholder="La tua password" required autocomplete="current-password" />
                    ...
                    <div class="olo-lf-row">
                        ...
                        <?php if ( $show_lost_pw ) : ?>
                        <a href="<?php echo esc_url( wp_lostpassword_url() ); ?>" class="olo-lf-link">Password dimenticata?</a>
                        <?php endif; ?>
                    </div>
                    <button type="submit" class="olo-lf-submit"><?php echo $login_btn_text; ?></button>
                </form>
                <?php if ( $mode === 'both' ) : ?>
                <div class="olo-lf-switch">Non hai un account? <a href="#" data-olo-switch="register" data-olo-uid="<?php echo esc_attr( $uid ); ?>">Registrati</a></div>
                <?php endif; ?>
            </div>
            <?php endif; ?>
            ...
            <div class="olo-lf-panel<?php echo $reg_active; ?>" data-olo-panel="register" data-olo-uid="<?php echo esc_attr( $uid ); ?>">
                ...
                <?php endif; ?>
                <?php if ( $mode === 'both' ) : ?>
                <div class="olo-lf-switch">Hai già un account? <a href="#" data-olo-switch="login" data-olo-uid="<?php echo esc_attr( $uid ); ?>">Accedi</a></div>
                <?php endif; ?>
            </div>
            <?php endif; ?>
    ...
    public static function render_user_profile_fields( $user ) {
        ...
        ?>
        <h3>Dati registrazione (Olobuild)</h3>
