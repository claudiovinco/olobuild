...
class Olobuild_SearchHero_Tile extends Olobuild_Tile_Base {
    ...
    protected $defaults = [
        ...
        'bg_color'        => 'var(--olo-color-dark, #1a1a22)',
        'panel_color'     => 'var(--olo-color-dark, #26262f)',
        'accent'          => 'var(--olo-color-primary, #ff5a5f)',
        'accent_on'       => 'var(--olo-color-light, #ffffff)',
        'glow_color'      => 'rgba(255,90,95,0.22)',
        'text_color'      => 'var(--olo-color-light, #ffffff)',
        'sub_color'       => 'var(--olo-color-text-soft, #6c6c7c)',
        'chip_color'      => 'var(--olo-color-text-faint, #a6a6b4)',
