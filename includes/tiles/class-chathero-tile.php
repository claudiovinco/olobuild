 ...
 */
class Olobuild_ChatHero_Tile extends Olobuild_Tile_Base {
    ...
    protected $defaults = [
        ...
        // Aspetto / colori
        'bg_color'       => 'var(--olo-color-dark, #140e22)',
        'panel_color'    => 'var(--olo-color-dark, #1e1633)',
        'panel2_color'   => 'var(--olo-color-dark, #271d42)',
        'accent'         => '',
        'accent2'        => '',
        'accent_on'      => 'var(--olo-color-light, #ffffff)',
        'text_color'     => 'var(--olo-color-light, #ffffff)',
        'sub_color'      => 'var(--olo-color-text-soft, #776e92)',
        'msg_text_color' => 'var(--olo-color-text-faint, #b3a9cc)',
        'pill_color'     => '',
        // Glow radiale
