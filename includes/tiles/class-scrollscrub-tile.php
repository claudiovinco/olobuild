...
class Olo_Scrollscrub_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings ) {
                            ...
                            ?>
                                <div class="olo-scrub__item olo-scrub__item--<?php echo intval( $i ); ?>"<?php echo $item_style ? ' style="' . esc_attr( $item_style ) . '"' : ''; ?>>
                                    ...
                                    <div class="olo-scrub__body">
                                        ...
                                        <?php endif; ?>
                                        <?php if ( $text_html !== '' ) : ?>
                                            <div class="olo-scrub__text" data-olo-editable="items.<?php echo intval( $i ); ?>.text" data-olo-richtext><?php echo $text_html; ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            <?php endforeach; ?>
        ...
        if ( $border_css || $border_hover_css || $border_effect_css ) {
            echo '<style>';
            if ( $border_css ) { echo "{$item_sel}{{$border_css}}"; }
