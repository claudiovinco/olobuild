 ...
 */
class Olo_Physicsbin_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        <div class="olo-physicsbin <?php echo esc_attr( $uid ); ?>" data-olo-pb
            ...
            foreach ( $items as $i => $it ) {
                ...
                if ( $it['img'] ) {
                    echo '<img src="' . $it['img'] . '" alt="" loading="lazy" />';
                } elseif ( $it['glyph'] !== '' ) {
        ...
        (function(){
            ...
            var G    = <?php echo json_encode( $gravity ); ?>;
            var REST = <?php echo json_encode( $restitution ); ?>;
            var FR   = <?php echo json_encode( $friction ); ?>;
            var WALLS = <?php echo json_encode( $walls ); ?>;
            var SPAWN = <?php echo json_encode( $spawn ); ?>;
