...
class Olobuild_Woo_Breadcrumbs_Tile extends Olobuild_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        ob_start();
        ?>
        <?php // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped -- inline CSS below is built exclusively from values sanitized above: safe_color_css() whitelist (or fixed var() token fallback) for colours, max()/min()/absint() clamp for font size, in_array() whitelist for alignment, and the internally generated $uid. ?>
        <style>
            .<?php echo $uid; ?> {
        ...
        <div class="<?php echo esc_attr( $uid ); ?>">
            ...
            woocommerce_breadcrumb( [
                ...
                'wrap_before' => '<nav class="woocommerce-breadcrumb" aria-label="' . esc_attr( olobuild_t( 'Breadcrumb' ) ) . '">',
                'wrap_after'  => '</nav>',
                'before'      => '<span>',
                'after'       => '</span>',
                'home'        => olobuild_t( 'Home' ),
            ] );
            ?>
        </div>
        <?php
