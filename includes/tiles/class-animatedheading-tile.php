...
class Olo_Animatedheading_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        <div class="olo-animatedheading <?php echo $uid; ?>">
            <<?php echo $tag; ?> class="olo-ah-heading">
        ...
        <script>
        (function(){
            var el = document.querySelector('.<?php echo $uid; ?> .olo-ah-word');
            if(!el) return;
