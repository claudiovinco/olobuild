...
class Olobuild_Countdown_Tile extends Olobuild_Tile_Base {
    ...
    private function render_custom( $s ) {
        ...
        ob_start();
        ?>
        <?php // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped -- inline CSS below is built exclusively from values sanitized above: absint() for every size/weight, safe_color_css() whitelist for every colour, Olobuild_Tile_Utils::spacing_css()/build_border_radius_css() (integer-forced) and fixed ternary literals; uid is generated internally. ?>
        <style>
            .<?php echo $uid; ?> {
                display: flex;
