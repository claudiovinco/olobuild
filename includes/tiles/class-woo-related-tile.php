...
class Olobuild_Woo_Related_Tile extends Olobuild_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        if ( empty( $related_ids ) ) {
            return '<div style="padding:20px;text-align:center;color:var(--olo-color-text-muted, #6B7280);font-size:14px;">'
                 . esc_html( olobuild_t( 'Nessun prodotto correlato trovato' ) )
                 . '</div>';
        }
        ...
        ob_start();
        ?>
        <?php // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped -- inline CSS below is built exclusively from values sanitized above: safe_color_css() whitelist for title/price colours, absint() with min()/max() clamps for columns/gap, fixed literal $card_extra from a whitelisted ternary; $uid is internally generated. ?>
        <style>
        ...
        <div class="<?php echo esc_attr( $uid ); ?>">
            ...
            <h2 class="olo-related-heading"><?php echo esc_html( olobuild_t( $s['heading_text'] ) ); ?></h2>
            <?php endif; ?>
                ...
                <div class="olo-related-card">
                    ...
                    <div class="olo-related-img">
                        ...
                        <a href="<?php echo esc_url( $permalink ); ?>">
                            <?php echo wp_get_attachment_image( $thumb_id, 'woocommerce_thumbnail' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- image markup generated and escaped by WordPress core wp_get_attachment_image() ?>
                        </a>
                        <?php else : ?>
                    ...
                    <div class="olo-related-body">
                        ...
                        <div class="olo-related-price"><?php echo $price_html; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- price HTML generated and escaped by WooCommerce WC_Product::get_price_html() ?></div>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endwhile; ?>
