...
class Olobuild_Progresstracker_Tile extends Olobuild_Tile_Base {
            ...
            <div class="olo-pt-h-wrap">
                ...
                <div class="olo-pt-h-step">
                    ...
                    <div class="olo-pt-h-label">
                        <?php list( $ptt_cls, $ptt_data ) = $this->tfx_attrs( $s, "title", $item["title"] ); ?><div class="olo-pt-title<?php echo $ptt_cls; ?>"<?php echo $ptt_data; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- tfx class/data attrs built by Olobuild_Text_Effects with sanitize_html_class()/esc_attr()'d values ?>><?php echo esc_html( $item["title"] ); ?></div>
                        <?php if ( $show_desc ) : ?>
                            <?php if ( ! empty( $item['description'] ) ) : ?>
                            <?php list( $ptd_cls, $ptd_data ) = $this->tfx_attrs( $s, "description", $item["description"] ); ?><div class="olo-pt-desc<?php echo $ptd_cls; ?>"<?php echo $ptd_data; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- tfx class/data attrs built by Olobuild_Text_Effects with sanitize_html_class()/esc_attr()'d values ?>><?php echo esc_html( $item["description"] ); ?></div>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
                </div>
