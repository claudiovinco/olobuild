...
class Olobuild_LangSwitcher_Tile extends Olobuild_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        if ( $radius_hover_css !== '' ) {
            // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped -- inline CSS built from the internally generated $ols_uid and the absint()-based Olobuild_Tile_Utils::radius_force_css() value.
            echo '<style>'
        ...
        if ( $border_css || $border_hover_css || $border_effect_css ) {
            echo '<style>';
            if ( $border_css ) echo ".{$ols_uid}{{$border_css}}"; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CSS generated by Olobuild_Tile_Base::build_border_css() from sanitized border settings; $ols_uid is internally generated
