 ...
 */
class Olobuild_FeaturedStory_Tile extends Olobuild_Tile_Base {
    ...
    protected $defaults = [
        ...
        // Colors
        'bg_color'       => 'var(--olo-color-light, #f3f0e9)',
        'kicker_color'   => 'var(--olo-color-primary, #9a2b22)',
        'headline_color' => 'var(--olo-color-dark, #16161a)',
        'accent_color'   => '',
        'standfirst_color' => 'var(--olo-color-text, #2c2c30)',
        'byline_color'   => 'var(--olo-color-text-soft, #76746e)',
        'byline_name_color' => 'var(--olo-color-dark, #16161a)',
        'media_bg'       => 'var(--olo-color-surface-alt, #e9e4d8)',
        'cta_solid_bg'   => 'var(--olo-color-dark, #16161a)',
        'cta_solid_text' => 'var(--olo-color-light, #f3f0e9)',
        // Fonts
