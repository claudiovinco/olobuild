    ...
    public function render( $settings ) {
        ...
        <nav class="olo-toc <?php echo esc_attr( $uid ); ?> olo-toc-preset-<?php echo esc_attr( sanitize_key( $s['preset'] ?? 'custom' ) ); ?>" id="<?php echo esc_attr( $uid ); ?>">
            <?php if (!empty($s['title'])) : ?>
                ...
                <div class="olo-toc-title<?php echo $tt_cls; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- tfx_attrs() fragments are escaped internally by Olo_Text_Effects (sanitize_html_class/esc_attr); title escaped inline ?>"<?php echo $tt_data; ?>><?php echo esc_html($s['title']); ?></div>
            <?php endif; ?>
