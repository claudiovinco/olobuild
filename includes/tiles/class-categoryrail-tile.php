 ...
 */
class Olobuild_CategoryRail_Tile extends Olobuild_Tile_Base {
            ...
            <div class="ocr-track" data-ocr-track>
                ...
                ?>
                    <a class="ocr-card" href="<?php echo esc_url( $href ); ?>">
                        <span class="ocr-media"<?php echo $isty; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- style attribute assembled above from fixed literals + esc_url()'d image ?>></span>
