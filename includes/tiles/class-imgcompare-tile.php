...
class Olobuild_ImgCompare_Tile extends Olobuild_Tile_Base {
    ...
    public function render( $settings ) {
        ...
        <div class="olo-ic <?php echo esc_attr( $uid ); ?> olo-ic-preset-<?php echo esc_attr( sanitize_key( $s['preset'] ?? 'custom' ) ); ?>" data-orientation="<?php echo esc_attr( $orientation ); ?>">
            ...
            <?php endif; ?>
            <input type="range" min="0" max="100" value="<?php echo (int) $start; ?>" class="olo-ic-range" aria-label="<?php echo esc_attr( olobuild_t( 'Confronto immagini' ) ); ?>" />
        </div>
