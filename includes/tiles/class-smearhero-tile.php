...
class Olobuild_SmearHero_Tile extends Olobuild_Tile_Base {
    ...
    protected $defaults = [
        ...
        'bg_color'        => 'var(--olo-color-dark, #1c1a17)',
        'glow_color'      => 'rgba(224,177,58,0.08)',
        'eyebrow_color'   => 'var(--olo-color-accent, #e0b13a)',
        'text_color'      => 'var(--olo-color-light, #f0ebe1)',
        'accent_color'    => '',
        'sub_color'       => 'var(--olo-color-light, #f0ebe1)',
        'hint_color'      => 'var(--olo-color-text-soft, #857c6d)',
