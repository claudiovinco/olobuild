...
class Olo_Projector_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings, $style = [] ) {
        ...
        <?php if ( $border_hover_css || $border_effect_css ) : ?><style><?php echo $border_hover_css . $border_effect_css; ?></style><?php endif; ?>
        ...
        <script>
        (function(){
            var p=document.querySelector('.<?php echo $uid; ?>[data-project]'); if(!p){return;}
