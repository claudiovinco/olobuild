 ...
 */
class Olo_Projector_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings, $style = [] ) {
        ...
        <?php if ( $border_hover_css || $border_effect_css ) : ?><style><?php echo $border_hover_css . $border_effect_css; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CSS generated by Olo_Tile_Base::build_border_hover_css()/build_border_effect_css() from sanitized settings ?></style><?php endif; ?>
