...
class Olobuild_Projector_Tile extends Olobuild_Tile_Base {
    ...
    public function render( $settings, $style = [] ) {
        ...
        <?php if ( $border_hover_css || $border_effect_css || $radius_hover_css ) : ?><style><?php echo $border_hover_css . $border_effect_css . $radius_hover_css; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CSS generated by Olobuild_Tile_Base::build_border_hover_css()/build_border_effect_css() and Olobuild_Tile_Utils::radius_hover_rules() (integer px) from sanitized settings ?></style><?php endif; ?>
