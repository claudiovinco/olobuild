 ...
 */
class Olobuild_MatchFixtures_Tile extends Olobuild_Tile_Base {
    ...
    protected $defaults = [
        ...
        'columns'          => 3,
        'gap'              => 16,
        'card_bg'          => 'var(--olo-color-dark, #0f3a2a)',
        'card_border'      => 'rgba(255,255,255,0.1)',
        'accent'           => '',
        'day_color'        => 'var(--olo-color-light, #ffffff)',
        'meta_color'       => 'rgba(255,255,255,0.55)',
        'name_color'       => 'var(--olo-color-light, #ffffff)',
        'score_color'      => 'var(--olo-color-light, #ffffff)',
        'crest_text_color' => 'var(--olo-color-light, #ffffff)',
        'radius'           => 18,
