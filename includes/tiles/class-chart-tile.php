...
class Olobuild_Chart_Tile extends Olobuild_Tile_Base {
    ...
    protected $defaults = [
        ...
        'tooltip_bg'           => 'var(--olo-color-dark, #000000)',
        'tooltip_text_color'   => 'var(--olo-color-light, #ffffff)',
    ...
    public function render( $settings ) {
        ...
        if ( ! self::$chartjs_enqueued ) {
            ...
            wp_enqueue_script( 'chartjs', OLOBUILD_URL . 'assets/vendor/chartjs/chart.umd.min.js', [], '4.5.1', true );
        }
