...
class Olo_ImageHero_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings, $style = [] ) {
        ...
        <section class="olo-imagehero <?php echo esc_attr( $uid ); ?>">
            <div class="oih-media"><?php if ( $mb['has'] && $mb['markup'] !== '' ) { echo $mb['markup']; } // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- media markup generated by Olo_CSS_Builder::get_bg_html_markup() which escapes its own attributes ?></div>
