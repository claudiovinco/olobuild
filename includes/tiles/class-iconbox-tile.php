...
class Olo_IconBox_Tile extends Olo_Tile_Base {
    ...
    public function render( $settings, $style = [] ) {
        ...
        ob_start();
        ?>
        <?php // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped -- inline CSS below is built exclusively from values sanitized above: colours via the safe_color_css() whitelist, intval()/absint()/floatval() numerics, in_array() whitelists with fixed-literal ternaries for position/shape, Olo_Tile_Utils::radius_force_css() and build_border_css()/build_border_hover_css()/build_border_effect_css() helpers; $uid is internally generated. ?>
        <style>
            .<?php echo $uid; ?> {
