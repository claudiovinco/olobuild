...
class Olo_Seo_Settings {
    ...
    public function render_page() {
        ...
        <main class="olo-cockpit-main olo-cockpit-legacy olo-seo-wrap">
            <?php
            // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- HTML generated by Olo_Builder::cockpit_page_head(); dynamic values escaped internally (esc_html/wp_kses_post)
            ...
            <form method="post" action="options.php" class="olo-seo-form" style="margin-top:16px">
                ...
                <div style="margin-top:24px;">
                    <?php
                    // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- HTML generated by Olo_Builder::cockpit_button(); dynamic values escaped internally (esc_attr/esc_html)
